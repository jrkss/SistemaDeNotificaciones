...
public class CampusDocenteActivity extends AppCompatActivity {
...
/////////////Referencias/////////////////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_campus_docente);
        ///////////////////////Ref///////////////////////////
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (campus.equals("Zongolica")){
                        ...
                        Toast.makeText(CampusDocenteActivity.this, "No se ha encontrado su campus", Toast.LENGTH_SHORT).show();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.campusCaid:
                        startActivity(new Intent(getApplicationContext(), CCarreraDocenteActivity.class));
                        overridePendingTransition(0, 0);
                        return true;

                    case R.id.carrerazid:
                        startActivity(new Intent(getApplicationContext(), CarreraDocenteActivity.class));
                        overridePendingTransition(0, 0);
                        return true;
                    case R.id.itszid:
                        startActivity(new Intent(getApplicationContext(), PrincipalDocente.class));
                        overridePendingTransition(0, 0);
                        return true;

                    case R.id.menuid:
                        startActivity(new Intent(getApplicationContext(), MenuDocenteActivity.class));
                        overridePendingTransition(0,0);
                        return true;
    ...
    private void returnLogin() {
        startActivity(new Intent(CampusDocenteActivity.this, LoginActivity.class));
        finish();
    }
