...
public class Tezonapams extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tezonapams);
        ...
        databaseReference = database.getReference("Tezonapams");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(Tezonapams.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Tezonapams.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_tezonapa");//imagenes_chat
        ...
        if (requestCode == DOC_SEND && resultCode == RESULT_OK){
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_Tezonapa");
    ...
    private void returnLogin() {
        startActivity(new Intent(Tezonapams.this, LoginActivity.class));
        finish();
    }
}