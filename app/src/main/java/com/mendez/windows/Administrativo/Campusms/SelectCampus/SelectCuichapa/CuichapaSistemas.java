...
public class CuichapaSistemas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuichapa_sistemas);
        ...
        databaseReference = database.getReference("CuichapaSistemas");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(CuichapaSistemas.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CuichapaSistemas.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_cuichapa_sistemas");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_cuichapa_sistemas");
    ...
    private void returnLogin() {
        startActivity(new Intent(CuichapaSistemas.this, LoginActivity.class));
        finish();
    }
}