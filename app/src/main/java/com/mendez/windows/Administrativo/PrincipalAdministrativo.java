...
import com.mendez.windows.Administrativo.ModeloA.Mensaje;
import com.mendez.windows.Administrativo.ModeloA.MensajeD;
import com.mendez.windows.Administrativo.ModeloA.MensajeEnviar;
import com.mendez.windows.Administrativo.ModeloA.MensajeEnviarD;
...
public class PrincipalAdministrativo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pincipal_administrativo);
        ///////////////////////Ref///////////////////////////
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(PrincipalAdministrativo.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(PrincipalAdministrativo.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_itzs");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_ITSZ");
    ...
    private void returnLogin() {
        startActivity(new Intent(PrincipalAdministrativo.this, LoginActivity.class));
        finish();
    }
