...
import com.mendez.windows.Administrativo.Campusms.SelectCampus.SelectTequila.TequilaDesarrollo;
...
public class TezonapaDesarrollo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tezonapa_desarrollo);
        ...
        databaseReference = database.getReference("TezonapaDesarrollo");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(TezonapaDesarrollo.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TezonapaDesarrollo.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_tezonapa_desarrollo");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_tezonapa_desarrollo");
    ...
    private void returnLogin() {
        startActivity(new Intent(TezonapaDesarrollo.this, LoginActivity.class));
        finish();
    }
}