...
public class TequilaInnovacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tequila_innovacion);
        ...
        databaseReference = database.getReference("TequilaInnovacion");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(TequilaInnovacion.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TequilaInnovacion.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_tequila_innovacion");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_tequila_innovacion");
    ...
    private void returnLogin() {
        startActivity(new Intent(TequilaInnovacion.this, LoginActivity.class));
        finish();
    }
}