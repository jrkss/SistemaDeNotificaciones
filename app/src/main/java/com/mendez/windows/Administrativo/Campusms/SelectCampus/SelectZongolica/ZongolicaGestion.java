...
public class ZongolicaGestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zongolica_gestion);
        ...
        databaseReference = database.getReference("ZongolicaGestion");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(ZongolicaGestion.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ZongolicaGestion.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_zongolica_gestion");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_zongolica_gestion");
    ...
    private void returnLogin() {
        startActivity(new Intent(ZongolicaGestion.this, LoginActivity.class));
        finish();
    }
}