...
public class ZongolicaSistemas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zongolica_sistemas);
        ...
        databaseReference = database.getReference("ZongolicaSistemas");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(ZongolicaSistemas.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ZongolicaSistemas.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_zongolica_sistemas");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_zongolica_sistemas");
    ...
    private void returnLogin() {
        startActivity(new Intent(ZongolicaSistemas.this, LoginActivity.class));
        finish();
    }
}