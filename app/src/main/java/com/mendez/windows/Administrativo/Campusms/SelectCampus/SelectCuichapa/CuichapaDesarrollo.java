...
public class CuichapaDesarrollo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuichapa_desarrollo);
        ...
        databaseReference = database.getReference("CuichapaDesarrollo");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(CuichapaDesarrollo.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CuichapaDesarrollo.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_cuichapa_desarrollo");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_cuichapa_desarrollo");
    ...
    private void returnLogin() {
        startActivity(new Intent(CuichapaDesarrollo.this, LoginActivity.class));
        finish();
    }
}