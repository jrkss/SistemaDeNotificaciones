...
public class TezonapaForestal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tezonapa_forestal);
        ...
        databaseReference = database.getReference("TezonapaForestal");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(TezonapaForestal.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TezonapaForestal.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_tezonapa_forestal");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_tezonapa_forestal");
    ...
    private void returnLogin() {
        startActivity(new Intent(TezonapaForestal.this, LoginActivity.class));
        finish();
    }
}