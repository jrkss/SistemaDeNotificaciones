package com.mendez.windows.Administrativo.MensajeCarrera;
...
public class SustentableAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sustentable_admin);
        ...
        databaseReference = database.getReference("Sustentablems");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(SustentableAdmin.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SustentableAdmin.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_Sustentable");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_Sustentable");
    ...
    private void returnLogin() {
        startActivity(new Intent(SustentableAdmin.this, LoginActivity.class));
        finish();
    }
}