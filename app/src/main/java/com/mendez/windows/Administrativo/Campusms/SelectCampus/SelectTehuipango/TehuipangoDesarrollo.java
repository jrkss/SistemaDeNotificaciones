...
import com.mendez.windows.Administrativo.Campusms.SelectCampus.SelectNogales.NogalesSistemas;
...
public class TehuipangoDesarrollo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tehuipango_desarrollo);
        ...
        databaseReference = database.getReference("TehuipangoDesarrollo");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(TehuipangoDesarrollo.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TehuipangoDesarrollo.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_tehuipango_desarrollo");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_tehuipango_desarrollo");
    ...
    private void returnLogin() {
        startActivity(new Intent(TehuipangoDesarrollo.this, LoginActivity.class));
        finish();
    }
}