...
import com.mendez.windows.Administrativo.CCarreraAdminActivity;
import com.mendez.windows.Administrativo.CampusAdminActivity;
import com.mendez.windows.Administrativo.CarreraAdminActivity;
import com.mendez.windows.Administrativo.MenuAdminActivity;
...
public class JefeGrupo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jefe_grupo);
        ...
        /*btnEnviarDoc = (ImageButton) findViewById(R.id.btnEnviarDocument);
        ...
        databaseReference = database.getReference("JefeGrupo");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(JefeGrupo.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarDoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_GET_CONTENT);
                i.setType("application/pdf");
                i.putExtra(Intent.EXTRA_LOCAL_ONLY, true);
                startActivityForResult(Intent.createChooser(i, "Seleccione un archivo PDF"), DOC_SEND);
            }
        });
         */
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(JefeGrupo.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_jefe");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_Jefe");
    ...
    private void returnLogin() {
        startActivity(new Intent(JefeGrupo.this, LoginActivity.class));
        finish();
    }
