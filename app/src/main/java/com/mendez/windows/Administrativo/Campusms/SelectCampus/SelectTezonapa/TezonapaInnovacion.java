...
public class TezonapaInnovacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tezonapa_innovacion);
        ...
        databaseReference = database.getReference("TezonapaInnovacion");//Sala de chat (nombre) version 2
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!mensaje.isEmpty()){
                    ...
                    Toast.makeText(TezonapaInnovacion.this, "Escriba un mensaje...", Toast.LENGTH_SHORT).show();
                }
        ...
        btnEnviarFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TezonapaInnovacion.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PHOTO_SEND && resultCode == RESULT_OK) {
            Uri u = data.getData();
            storageReference = storage.getReference("imagenes_tezonapa_innovacion");//imagenes_chat
            ...
            Uri u = data.getData();
            storageReference = storage.getReference("Documentos_tezonapa_innovacion");
    ...
    private void returnLogin() {
        startActivity(new Intent(TezonapaInnovacion.this, LoginActivity.class));
        finish();
    }
}